 ...
 */
public final class BuildingFloorSortCBF implements Comparator<Buildingfloor> {
    ...
    public int compare(Buildingfloor o1, Buildingfloor o2) {
        String a = o1.getFloorName().toLowerCase();
        String b = o2.getFloorName().toLowerCase();
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(scrambled,
                BuildingFloorSortCBF.NUMERICAL_ORDER);
