 ...
 */
public final class BuildingSortCBF implements Comparator<Building> {

    public static final Comparator NUMERICAL_ORDER = new BuildingSortCBF();
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(scrambled,
                BuildingSortCBF.NUMERICAL_ORDER);
